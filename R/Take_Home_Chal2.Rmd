...
## plot.background = element_rect(fill = "transparent", colour = NA) to make transparent

```

## Make a personal presentation theme (font min 28, transparent fill maybe, )
...
```{r}
say("gobble gobble", by = "behindcat", by_color = "forestgreen", what_color = "red")
